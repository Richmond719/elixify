...
<div class="bg-primary border-end text-white" id="sidebar-wrapper">
    ...
    <div class="list-group list-group-flush">
        ...
        <a href="{{ route('admin.job_postings.index') }}" class="list-group-item list-group-item-action text-white border-0 {{ Request::is('admin/job_postings*') ? 'bg-secondary' : 'bg-primary' }}"><i
        ...
        <!-- Profile last -->
        <a href="{{ route('admin.profile') }}" class="list-group-item list-group-item-action text-white border-0 {{ Request::is('admin/profile') ? 'bg-secondary' : 'bg-primary' }}"><i
